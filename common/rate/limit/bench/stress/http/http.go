...
import (
	...
	"github.com/weikaishio/databus_kafka/common/rate"
	"github.com/weikaishio/databus_kafka/common/rate/limit"
	"github.com/weikaishio/databus_kafka/common/rate/limit/bench/stress/conf"
	"github.com/weikaishio/databus_kafka/common/rate/limit/bench/stress/service"
	"github.com/weikaishio/databus_kafka/common/rate/vegas"
)
...
func aqmTest(c *bm.Context) {
	...
	for i := 0; i < 3000+rand.Intn(3000); i++ {
		crc32.Checksum([]byte(`testasdwfwfsddsfgwddcscsc
			http://git.domain.co/platform/go-common/merge_requests/new?merge_request%5Bsource_branch%5D=stress%2Fcodel`), crc32.IEEETable)
	}
}
